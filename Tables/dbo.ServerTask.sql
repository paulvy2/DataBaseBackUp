...
[DurationSeconds] [int] NOT NULL CONSTRAINT [DF__ServerTas__Durat__0B91BA14] DEFAULT ((0))
...
GO
CREATE NONCLUSTERED INDEX [IX_ServerTask_TenantId] ON [dbo].[ServerTask] ([TenantId]) ON [PRIMARY]
GO
